[![build](https://github.com/opspec-pkgs/base64.encode/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/base64.encode/actions/workflows/build.yml)
